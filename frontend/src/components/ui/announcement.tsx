...
export const Announcement = ({
  ...
  <BadgeContext.Provider value={{ themed }}>
    <Badge
      variant={variant}
      className={cn(
        'max-w-full gap-2 rounded-full bg-background px-3 py-0.5 font-medium shadow-sm transition-all cursor-pointer border border-[#d7b73b]/50 text-[#d7b73b] hover:bg-[#d7b73b]/10 backdrop-blur-md',
        'hover:shadow-md hover:border-[#d7b73b]',
...
export const AnnouncementTag = ({
  ...
  return (
    <div
      className={cn(
        '-ml-2.5 shrink-0 truncate rounded-full bg-[#d7b73b] text-black px-2.5 py-1 text-xs font-bold',
...
export const AnnouncementTitle = ({
  ...
  <div
    className={cn('flex items-center gap-1 truncate py-1 text-sm text-white', className)}
    {...props}
  />
);
